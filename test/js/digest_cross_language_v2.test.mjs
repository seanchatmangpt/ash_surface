 ...
 *     per-action `irRef` keys, all accepted by the v26.9.16 schema — inside
 ...
 * profile, which the v26.9.16 delegated-facts law (v10) removed on both
