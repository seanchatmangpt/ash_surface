...
const GOLDENS = [
  {
    ...
    elixirDigest: "1d2f78480ad8261b83dd7182fc84aa54aa833f58fc813939a713c16d9d9f2d5f",
    contractJson:
  ...
  },
  {
    ...
    elixirDigest: "ddb95be74b2ce5b78fbe5ce8d14807d2af75426083cb0623abb587ff827cbbf1",
    contractJson:
  ...
  },
  {
    ...
    elixirDigest: "c4f7b471c2ae774ccc97d9ec64c7c9476ac291d4e88efcd3f0bfd8d94524e0b0",
    contractJson:
      '{"ashManifestSchemaVersion":"1.0.0","generatorIdentity":"ash_surface:v26.9.17","manifest":{"entrypoints":[{"action":{"get":null,"inputs":[],"metadata":[],"primary":null,"type":"read"},"resource":"AshSurface.Fixtures.VolunteerMilestone"}],"resources":[],"schema_version":"1.0.0","types":[]},"manifestDigest":"c40b103081fb6909366d75fdfe06453a4e13ab625ea3829b3c4e16b8bb9f3c09","marketplaceIdentity":"ggen-marketplace:v26.9.17","surface":{"actions":[{"action":"read","authorityBoundary":"OBSERVE","doAuthority":false,"evidenceRequired":false,"id":"AshSurface.Fixtures.VolunteerMilestone#read","possibleRefusals":[],"profile":{"consumer":"web","transport":"phoenix_channel"},"receiptRequired":true,"resource":"AshSurface.Fixtures.VolunteerMilestone","semanticId":"ash:AshSurface.Fixtures.VolunteerMilestone#read"}],"profile":{}},"surfaceSchemaVersion":"26.9.17"}',
  },
];
