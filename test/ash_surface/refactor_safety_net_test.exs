defmodule AshSurface.RefactorSafetyNetTest do
  ...
  @canon [
    ...
    {"ir_codec", "ash_surface/ir_codec_test.exs",
     "IR codec serialization and content-addressing law"},
    {"ir_struct", "ash_surface/ir_struct_test.exs",
     "IR + five embedded sections canonical shape"},
