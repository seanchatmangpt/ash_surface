defmodule AshSurface.MXClosedLoopDeepTest do
  ...
  # Mirrors the mx-episode-schema@v26.9.13 required-field law used by
  ...
  test "composed MX receipt carries the full provenance lattice of the episode",
    ...
    assert surface.contract["generatorIdentity"] == "ash_surface:v26.9.13"
  ...
  # ---------------------------------------------------------------------------
  # Elixir-side episode law (test-local mirror of mx-episode-schema@v26.9.13,
