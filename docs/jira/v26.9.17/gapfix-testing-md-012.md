...
2026-09-17T00:29:38Z | MERGED 6ba374a + repairs (rider): exp/gapfix-testing-md-012; landed mix 771/0, format 0; counts landing-true 771/68+220/16; ledger row SUBSTITUTION precedent (old falsified row retired by same-path new row — path-union discards it); tripwire parser constraint recorded: capability fields must stay quote-free (backtick-quote instead)
