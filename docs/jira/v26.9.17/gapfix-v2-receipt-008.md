...
2026-09-16T23:54:47Z | MERGED ec70861  (rider): --no-ff exp/gapfix-v2-receipt-008; landed mix 761/0; v2 now receipted on landed tree (six EXITs 0 + ZERO_CONFIG_OK @a7a6b40 clone); unblocks 009's deferred v2-CI-wiring (micro-scope, noted for backlog grooming)
