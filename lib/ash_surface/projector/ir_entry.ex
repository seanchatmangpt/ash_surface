# Reader over the canonical five-section IR for target projectors.
# (Landed as `AshSurface.Projector.IR` on exp/v18; renamed at v50
# integration — the v16 `Projector.IR` behaviour owns that name.)
defmodule AshSurface.Projector.IREntry do
  @moduledoc """
